...
leyesBiblio_url = os.environ["CONSTITUCION_JALISCO"]
...
pdf_links = soup.find_all('a', href=lambda href: href and "../legislacion" in href)
...
pdf_hrefs = ['https://congresoweb.congresojal.gob.mx/BibliotecaVirtual/' + href[2:] for href in pdf_hrefs]

for pdf_url in tqdm(pdf_hrefs, desc="Descargando los PDFs de Jalisco", unit="file"):
    ...
    folder_path = os.path.join(datasets, "jalisco")
