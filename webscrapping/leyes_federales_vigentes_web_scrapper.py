...
LeyesBiblio_url = os.environ["LEYES_FEDERALES_DE_MEXICO"]
...
pdf_links = soup.find_all('a', href=lambda href: href and href.startswith("pdf/"))
...
for pdf_url in tqdm(full_urls, desc="Descargando los PDFs Federales", unit="file"):
    ...
    folder_path = os.path.join(datasets, "federales")
