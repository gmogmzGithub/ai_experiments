...
leyesBiblio_url = os.environ["LEYES_CDMX"]
...
pdf_links = soup.find_all('a', href=lambda href: href and "archivo-" in href)
...
pdf_hrefs = ['https://www.congresocdmx.gob.mx/' + href for href in pdf_hrefs]

for pdf_url in tqdm(pdf_hrefs, desc="Descargando los PDFs de CDMX", unit="file"):
    ...
    folder_path = os.path.join(datasets, "cdmx")
